...
### Step 1:
Clone libcper to your local system: 
`https://github.com/openbmc/libcper.git`

### Step 2:
Generate master-schema.json, which consolidates all .json files in the libcper repo
...
### Help:
`python3 schemagen.py -h`
`python3 schemagen.py json_to_xml -h`
...
2. `python3 schemagen.py json_to_xml -s final_out.json -x "XML header" \
-f "XML footer" -p "XmlBaseType" -a sections`
